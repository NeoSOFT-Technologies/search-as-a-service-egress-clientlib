...
public class TestingController {
	...
	/*
	 * @GetMapping("/addDocument") public SolrGetCapacityPlanDTO addDocument()
	 * throws SolrServerException, IOException, URISyntaxException,
	 * ParserConfigurationException, InterruptedException, TransformerException,
	 * org.xml.sax.SAXException {
	 * 
	 * String SOLR_URL="http://localhost:8983/solr/S3Collection"; SolrClient
	 ...
	 * 
	 * solrClient.add(document); solrClient.commit();
	 * 
	 * return null;
	 * 
	 * }
